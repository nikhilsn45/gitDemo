            ...
            <div className="row">
                <div class="row">
                    ...
                    <div className="col-md-10">
                        <p>Aurangabad Road,Yeola,Maharashtra</p>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-2">
                    ...
                    <div className="col-md-10">
                        <p>mansinakod10@gmail.com   (+91 9373530634)</p>
                    </div>
                </div>
                <div className="row">
                    <div className="col-4">
                    ...
                    <div className="col-4">
                        <a href="https://github.com/MsNakod">
                    ...
                    <div className="col-4">
                        <a href="https://www.linkedin.com/in/mansi-nakod">
